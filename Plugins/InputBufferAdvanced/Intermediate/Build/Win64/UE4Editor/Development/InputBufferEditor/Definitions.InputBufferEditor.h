...
#define UE_PROJECT_NAME Legends_Of_Harmonya
#define UE_TARGET_NAME Legends_Of_HarmonyaEditor
#define UE_MODULE_NAME "InputBufferEditor"
#define UE_PLUGIN_NAME "InputBufferAdvanced"
